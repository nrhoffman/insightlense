...
/* harmony import */ var _utilities_initializeModel_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities/initializeModel.js */ "./content/utilities/initializeModel.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          _context2.next = 6;
          return (0,_utilities_initializeModel_js__WEBPACK_IMPORTED_MODULE_1__.initializeModel)(modelInstance, pageContent);
        case 6:
...
function _getPageContent() {
  _getPageContent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return _context4.abrupt("return", uniqueContent);
        case 6:
        case "end":
...
function _generateSummary() {
  _generateSummary = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(focusInput) {
...
function summarizePageContent(_x3) {
...
function _summarizePageContent() {
  _summarizePageContent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(focusInput) {
...
function summarizeLargePageContent(_x4, _x5, _x6) {
...
function _summarizeLargePageContent() {
  _summarizeLargePageContent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(separateLines, maxChar, focusInput) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 38:
          combinedSummary = _context7.sent;
          summarizer.destroy();
          return _context7.abrupt("return", combinedSummary);
        case 41:
        case "end":
          return _context7.stop();
      }
    }, _callee7, null, [[6, 23, 26, 29]]);
  }));
  return _summarizeLargePageContent.apply(this, arguments);
}
function getSummary(_x7, _x8) {
  return _getSummary.apply(this, arguments);
} // Helper function to get shared context for summarization
function _getSummary() {
  _getSummary = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(summarizer, prompt) {
    var retries,
      delay,
      summary,
      attempt,
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          retries = _args8.length > 2 && _args8[2] !== undefined ? _args8[2] : 5;
          delay = _args8.length > 3 && _args8[3] !== undefined ? _args8[3] : 1000;
          summary = '';
          attempt = 0;
        case 4:
          if (!(attempt < retries)) {
        ...
        case 12:
          ...
          console.log("Error summarizing content on attempt ".concat(attempt + 1, ":"), _context8.t0);
          attempt++;
          if (!(attempt < retries)) {
            _context8.next = 23;
            break;
...
// Function that gets
function getChatBotOutput(_x9) {
  return _getChatBotOutput.apply(this, arguments);
} // Function that displays fact check bubble
function _getChatBotOutput() {
  _getChatBotOutput = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(input) {
    var result;
...
function displayBubble(_x10, _x11) {
  return _displayBubble.apply(this, arguments);
} // Function to make the bubble draggable
function _displayBubble() {
  _displayBubble = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(selectedText, type) {
...
function fillInBubble(_x12, _x13, _x14, _x15) {
  return _fillInBubble.apply(this, arguments);
}
function _fillInBubble() {
  _fillInBubble = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11(bubble, type, summary, selectedText) {
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        ...
        case 5:
          _yield$ai$languageMod = _context11.sent;
        ...
        case 31:
          ...
          if (_context11.t0.message === "Other generic failures occurred.") {
            result = "Other generic failures occurred. Retrying...";
          } else {
            result = _context11.t0.message;
          }
          console.error("Error generating content:", _context11.t0);
        case 35:
          bubble.innerHTML = '';
          if (type === 'factCheckBubble') {
...
function analyzeContent(_x16) {
  return _analyzeContent.apply(this, arguments);
} // Function that analyzes web page content
function _analyzeContent() {
  _analyzeContent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee12(pageData) {
    var analysisContent;
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 5:
          ...
          analysisContent.innerHTML = _context12.t0.concat.call(_context12.t0, _context12.t1, "</span>");
          analysisReady = true;
        case 8:
        case "end":
...
function analyzePageText(_x17) {
  return _analyzePageText.apply(this, arguments);
} // Helper function to get the analysis prompt
function _analyzePageText() {
  _analyzePageText = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13(pageData) {
    var retries,
      delay,
      result,
      summary,
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        case 0:
          retries = _args13.length > 1 && _args13[1] !== undefined ? _args13[1] : 5;
          delay = _args13.length > 2 && _args13[2] !== undefined ? _args13[2] : 1000;
          result = '';
        ...
        case 16:
          ...
          console.log("Error analyzing content on attempt ".concat(attempt + 1, ":"), _context13.t0);
          attempt++;
          if (!(attempt < retries)) {
            _context13.next = 27;
            break;
        ...
        case 31:
          session.destroy();
          return _context13.abrupt("return", formatTextResponse(result));
        case 33:
        case "end":
